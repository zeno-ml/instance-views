...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(span0, "class", "label svelte-54vetn");
		...
		m(target, anchor) {
			...
			span1.innerHTML = /*renderedLabel*/ ctx[6];
		},
		p(ctx, dirty) {
			if (dirty & /*renderedLabel*/ 64) span1.innerHTML = /*renderedLabel*/ ctx[6];		},
		d(detaching) {
			if (detaching) detach(div);
		}
	};
