...
function add_css(target) {
	append_styles(target, "svelte-1wc861t", "#container.svelte-1wc861t.svelte-1wc861t{display:flex;flex-direction:column;border:0.5px solid rgb(224, 224, 224);min-width:350px;border-radius:2px;padding:10px}.label.svelte-1wc861t.svelte-1wc861t{margin-right:5px;font-weight:700}p.svelte-1wc861t.svelte-1wc861t{margin:5px;overflow-wrap:anywhere}.show-all.svelte-1wc861t.svelte-1wc861t{align-self:center;border:none;background-color:transparent;cursor:pointer;display:flex;align-items:center;padding:5px;border-radius:20px}.hover.svelte-1wc861t.svelte-1wc861t{background-color:var(--G5)}.show-all.svelte-1wc861t span.svelte-1wc861t{padding-right:5px}.show-all.svelte-1wc861t svg.svelte-1wc861t{min-width:24px;width:24px;fill:var(--G3)}");
}
...
function create_if_block_7(ctx) {
	...
	return {
		...
		h() {
			...
			attr(svg, "class", "svelte-1wc861t");
			attr(span, "class", "svelte-1wc861t");
			attr(div, "class", "show-all svelte-1wc861t");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "label svelte-1wc861t");
			attr(p, "class", "svelte-1wc861t");
		},
		m(target, anchor) {
			insert_hydration(target, p, anchor);
			append_hydration(p, span);
