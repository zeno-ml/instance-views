...
function add_css$3(target) {
	append_styles(target, "svelte-2deuln", ".model.svelte-2deuln.svelte-2deuln{fill:var(--logo)}.no-model.svelte-2deuln.svelte-2deuln{fill:var(--G3)}.model-border.svelte-2deuln.svelte-2deuln{border:1px solid var(--logo)}.no-model-border.svelte-2deuln.svelte-2deuln{border:1px solid rgba(224, 224, 224, 1)}.box.svelte-2deuln.svelte-2deuln{margin-top:10px;margin-bottom:10px;display:flex;align-items:start}.box.svelte-2deuln svg.svelte-2deuln{min-width:24px;width:24px;margin-right:10px;margin-top:7px}.chat.svelte-2deuln.svelte-2deuln{border-radius:5px;margin:0px;padding:10px}");
}
...
function create_fragment$3(ctx) {
	...
	return {
		...
		h() {
			...
			attr(svg, "class", svg_class_value = "" + (null_to_empty(/*output*/ ctx[1] ? "model" : "no-model") + " svelte-2deuln"));
			attr(p, "class", p_class_value = "chat " + (/*output*/ ctx[1] ? 'model-border' : 'no-model-border') + " svelte-2deuln");
			attr(div, "class", "box svelte-2deuln");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*output*/ 2 && svg_class_value !== (svg_class_value = "" + (null_to_empty(/*output*/ ctx[1] ? "model" : "no-model") + " svelte-2deuln"))) {
				attr(svg, "class", svg_class_value);
			}

			if (dirty & /*input*/ 1) set_data(t1, /*input*/ ctx[0]);

			if (dirty & /*output*/ 2 && p_class_value !== (p_class_value = "chat " + (/*output*/ ctx[1] ? 'model-border' : 'no-model-border') + " svelte-2deuln")) {
...
function add_css$1(target) {
	append_styles(target, "svelte-133nd56", ".box.svelte-133nd56.svelte-133nd56{margin-top:10px;margin-bottom:10px;display:flex;align-items:start}.box.svelte-133nd56 svg.svelte-133nd56{min-width:24px;width:24px;margin-right:10px;margin-top:7px;fill:var(--G3)}.chat.svelte-133nd56.svelte-133nd56{border:1px solid rgba(224, 224, 224, 1);border-radius:5px;margin:0px;padding:10px}");
}
...
function create_fragment$1(ctx) {
	...
	return {
		...
		h() {
			...
			attr(svg, "class", "svelte-133nd56");
			attr(p, "class", "chat svelte-133nd56");
			attr(div, "class", "box svelte-133nd56");
		},
		m(target, anchor) {
			insert_hydration(target, div, anchor);
			append_hydration(div, svg);
...
function add_css(target) {
	append_styles(target, "svelte-tl9nqj", "#container.svelte-tl9nqj{border:0.5px solid rgb(224, 224, 224);border-radius:2px;padding:10px}.label.svelte-tl9nqj{margin-right:5px;font-weight:700}p.svelte-tl9nqj{margin:5px;overflow-wrap:anywhere}");
}
